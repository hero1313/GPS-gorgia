...
@section('content')
            ...
            <div class="mb-3 container-fluid">
                <form method="get" action="{{ route('locations.index') }}"
                    ...
                    <div class="input-group">
                        <input type="text" class="border-0 form-control bg-light small objects-search" placeholder="Search"
    ...
    @foreach ($locations as $location)
        {{-- edit location --}}
        <div class="modal fade" id="edit_location_{{ $location->id }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-body row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" value="{{ $location->name }}"
                                        name="name">
                                </div>
                            </div>
                            <div class="col-6">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1">მდებარეობა</label>
                                <input id="pac_input" class="form-control" name="address" class="controls loc-input"
